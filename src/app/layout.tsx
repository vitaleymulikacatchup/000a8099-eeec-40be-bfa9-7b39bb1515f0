...
export const metadata: Metadata = {
  title: "Coffee Shop - The Best Brew in Town",
  description: "Welcome to our coffee shop where we serve the finest coffee blends. Join us for a delightful experience.",
  metadataBase: new URL("https://www.coffeeshop.com"),
  alternates: {
    canonical: "https://www.coffeeshop.com"
  },
  openGraph: {
    title: "Coffee Shop - The Best Brew in Town",
    description: "Welcome to our coffee shop where we serve the finest coffee blends. Join us for a delightful experience.",
    ...
    images: [{
      url: "https://images.pexels.com/photos/3352765/pexels-photo-3352765.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
  ...
  twitter: {
    ...
    title: "Coffee Shop - The Best Brew in Town",
    description: "Welcome to our coffee shop where we serve the finest coffee blends. Join us for a delightful experience.",
    images: ["https://images.pexels.com/photos/3352765/pexels-photo-3352765.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
